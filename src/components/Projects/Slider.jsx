...
let data = [
  ...
  {
    img:
      "https://res.cloudinary.com/ghazni/image/upload/v1661323979/Yt-portfolio/ui1_n3uiaz.png",
    disc: "My Writing Achievment or My Best Story",
  },
];
...
const SliderComp = () => {
  ...
  sliderProject = data.map((item, i) => (
    <ProjectDetails item={item} key={i} />
  ));
  return (
    <Container>
